...
const Menubar = () => {
  return (
    <div className="h-screen w-[16rem] border-r-1 border-[#DBDBDB] fixed left-0 flex items-start flex-col py-8">
      <div className="Menu_top w-full px-6 cursor-pointer">
        <svg
      ...
      <div className="Menu_center flex items-center flex-col gap-2 w-full mt-8 px-2">
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          <svg
            aria-label="Home"
            class="x1lliihq x1n2onr6 x5n08af"
            fill="currentColor"
          ...
          <h4 className="text-md font-semibold">Home</h4>
        </div>
        ...
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          ...
          <h4 className="text-md ">Search</h4>
        </div>
        ...
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          ...
          <h4 className="text-md ">Messages</h4>
        </div>
        ...
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          ...
          <h4 className="text-md ">Notifications</h4>
        </div>
        ...
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          ...
          <h4 className="text-md ">Create</h4>
        </div>
        ...
        <NavLink to={`/profile`} className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          <img
            className="h-8 w-8 rounded-full object-cover"
            src="https://i.pinimg.com/736x/63/0c/7a/630c7a335cb80e673f393d6eea9acd3d.jpg"
            alt=""
          />
      ...
      <div className="menu_bottom flex items-center flex-col px-2 bottom-3 mt-20 left-0 w-full">
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          <svg
            aria-label="Settings"
            class="x1lliihq x1n2onr6 x5n08af"
        ...
        <div className="menu_item w-full flex items-center px-4 gap-4 cursor-pointer py-3 rounded-md justify-start hover:bg-[#F2F2F2]">
          ...
          <h4 className="text-md ">Also from Meta</h4>
        </div>
      </div>
    </div>
  );
